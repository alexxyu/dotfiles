# Generated by Powerlevel10k configuration wizard on 2024-04-28 at 15:34 PDT.
...
() {
  ...
  # Actually, only shorten to the current directory name.
  ...
  typeset -g POWERLEVEL9K_SHORTEN_DIR_MAX_LENGTH=0
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # Otherwise show the first 20 … the last 20.
      # Tip: To always show local branch name in full without truncation, delete the next line.
      (( $#branch > 50 )) && branch[21,-21]="…"  # <-- this line
  ...
  # Format for the current time: 21:51:02. See `man 3 strftime`.
